...
function addPointToSelection(selection, node, offset, selectionState) {
  ...
  var nodeLength = node.nodeValue === null ? node.childNodes.length : node.nodeValue.length;
  ...
  if (offset > nodeLength) {
    ...
    var anonymizedDom = currentNode ? getAnonymizedDOM(currentNode) : 'Could not find contentEditable parent of node';

    DraftJsDebugLogging.logSelectionStateFailure({
      anonymizedDom: anonymizedDom,
